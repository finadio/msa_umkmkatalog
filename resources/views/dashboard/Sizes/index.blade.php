                            ...
                            <tr class="border-b hover:bg-gray-100">
                                <td class="w-4 px-4 py-3 items-center justify-end relative" x-data="{ open: false, dropdownPosition: 'bottom' }"
                                    ...
                                    <div x-show="open" x-transition
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button-{{ $size->name }}">
                                            <li>
                                                <a href="/dashboard/sizes/{{ $size->id }}/edit"
                                            ...
                                            <li>
                                                <form action="/dashboard/sizes/{{ $size->id }}" method="POST"
                                                    id="deleteForm-{{ $size->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" onclick="confirmDelete({{ $size->id }})"
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900">{{ $size->updated_at }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
